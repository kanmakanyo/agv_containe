...
ros::Publisher pub("nano_ultrasonic_rear", &pub_msg);
...
//   Serial.print("NANO_ULTRASONIK_REAR\t");
//   Serial.print("Jarak 6: ");
//   Serial.print(distance1);
//   Serial.print(" cm");
//   Serial.print("\t");
//   Serial.print("Jarak 7: ");
//   Serial.print(distance2);
//   Serial.print(" cm ");
//   Serial.print("\t");
//   Serial.print("Jarak 8: ");
//   Serial.print(distance3);
//   Serial.print(" cm ");
//   Serial.print("\t");
//   Serial.print("Jarak 9: ");
//   Serial.print(distance4);
//   Serial.print(" cm ");
//   Serial.print("\t");
//   Serial.print("Jarak 10: ");
