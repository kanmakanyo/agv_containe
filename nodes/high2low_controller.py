...
while not rospy.is_shutdown():
    ...
    if (mqtt_autonomous == 1):
        ...
        if (RECEIVED_STATE_VAL):
            ...
            pub_msg.pose.covariance[3] = mqtt_autonomous #mqtt_locker  #291221 digunakan sebagai indeks autonomous (backup)
    ...
    # topic = "test/publish/topic"
    # print("Publishing message to topic",topic)
    # client.publish(topic,mqtt_steer)
    # print(pub_msg.header.seq)
